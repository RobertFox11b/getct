#Connect to the Site        
Connect-PnPOnline -Url "https://dod365.sharepoint-mil.us/sites/DISA-EM" -UseWebLogin
...
ForEach($List in $Lists)
{
    ...
    If($ContentType)
    {
        ...
        $ContentTypeUsage | Add-Member NoteProperty SiteURL("https://site.com/site/site")
...
$ReportOutput = c:\temp\sharepoing_content_types.CSV
